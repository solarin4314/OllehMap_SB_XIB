...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (category == Favorite_Category_Local || category == Favorite_Category_Public)
    {
        ...
        [oms.searchResult setStrRdCd:rdCd];
...
- (void) onRenameFavorite:(id)sender
{
    ...
    UIAlertView *alert = [[[UIAlertView alloc] initWithTitle:@"즐겨찾기 이름" message:@"" delegate:self cancelButtonTitle:@"취소" otherButtonTitles:@"확인", nil] autorelease];
