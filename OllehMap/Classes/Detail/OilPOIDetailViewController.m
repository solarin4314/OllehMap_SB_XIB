...
- (void) drawTopView
{
    ...
    if(![self.addrNewStr isEqualToString:@""])
    {
        ...
        [poiNewAdd setFrame:CGRectMake(127, pAddress.frame.origin.y + pAddress.frame.size.height + 6 - 1, 183, 13)];
        
        // 서브주소이미지
        UIImageView *subImg = [[UIImageView alloc] init];
        [subImg setImage:[UIImage imageNamed:@"new_address_icon.png"]];
        [subImg setFrame:CGRectMake(90, pAddress.frame.origin.y + pAddress.frame.size.height + 6 - 1, 33, 15)];
