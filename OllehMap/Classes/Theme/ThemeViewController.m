...
-(void) subThemeClick:(id)sender
{
    ...
    [MainMapViewController markingThemePOI_ThemeCode:themeCode mainThemeCode:oms.themeInfoList [index] [@"code"] maxRenderingZoomLevel:[oms.themeInfoList [index] [@"scale"] intValue] selectedThemeName:themeName animated:NO];
