...
@synthesize currentRouteCarSelector = _currentRouteCarSelector;
...
- (void) renderCarListRouteSummaryInfo
{
    ...
    // 목록 요약정보 뷰 - 상단 배경 - 마스크
    UIImageView *imgvwMask01 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"info_align_bg_01_list_mask.png"]];
    [imgvwMask01 setFrame:CGRectMake(0, 0, 10, 35)];
    [vwCarRouteSummaryInfo addSubview:imgvwMask01];
    [imgvwMask01 release];
    UIImageView *imgvwMask02 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"info_align_bg_01_list_mask.png"]];
...
- (void) renderPublicListRouteSummaryInfo
{
    ...
    [vwPublicRouteSummaryInfo setBackgroundColor:[UIColor whiteColor]];
...
{
    int baseFare = 3000;
    int distanceFare = (int)(((int)distance - 2000)/142) * 100;
    int totalFare;
    if (distanceFare > 0)
    {
